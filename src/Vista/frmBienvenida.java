...
public class frmBienvenida extends javax.swing.JFrame {
    ...
    public static void initFrmBienvenida() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bienvenido al registro de contadores");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 40, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/Registro.png"))); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 260, 520, 360));

        btnEntrar.setBackground(new java.awt.Color(0, 51, 153));
        btnEntrar.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 36)); // NOI18N
        btnEntrar.setForeground(new java.awt.Color(255, 255, 255));
        btnEntrar.setText("Entrar");
        jPanel1.add(btnEntrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 230, 380, 100));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmBienvenida.initFrmBienvenida();
            }
        });
    }
